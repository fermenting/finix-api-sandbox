...
merchant_identity = Finix::Identity.new(
    {
        "tags"=> {
            "Studio Rating"=> "4.7"
        },
    ...
    puts(merchant_identity)

    merchant_ID = merchant_identity.id
    # puts (merchant_ID)

    merchant_bank_account = Finix::BankAccount.new(
        {
...
# puts merchant_bank_account

merchant = merchant_identity.provision_merchant
